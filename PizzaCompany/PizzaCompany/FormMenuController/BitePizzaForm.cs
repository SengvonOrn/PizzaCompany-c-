...
{
    public partial class BitePizzaForm : Form
    {
       
        public int id = SessionClass.CurrentCustomerId;
        public BitePizzaForm()
        {
            InitializeComponent();
        ...
        public void Getdata()
        {
            ...
            List<ProductModel> products = mainClass.GetProductsBySearch(searchMenu.Text, "Bite Pizza", "", "");
        ...
        private void BitePizzaForm_Load(object sender, EventArgs e)
        {
            Getdata();
