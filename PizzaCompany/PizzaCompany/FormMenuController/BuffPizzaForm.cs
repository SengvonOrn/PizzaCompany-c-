...
{
    public partial class BuffPizzaForm : Form
    {
        private FlowLayoutPanel flowPanel;
       
        public int id = SessionClass.CurrentCustomerId;
        public BuffPizzaForm()
        {
            InitializeComponent();
        }
        ...
        public void Getdata()
        {
            ...
            List<ProductModel> products = mainClass.GetProductsBySearch(searchMenu.Text, "Buff Pizza" , "", "");
        ...
        private void BuffPizzaForm_Load(object sender, EventArgs e)
        {
            Getdata();
