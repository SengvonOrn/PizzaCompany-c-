...
{
    public partial class MainBishForm : Form
    {
        ...
        public void Getdata()
        {
            ...
            List<ProductModel> products = mainClass.GetProductsBySearch(searchMenu.Text, "Main Bish" , "", "");
        ...
        private void MainBishForm_Load(object sender, EventArgs e)
        {
            Getdata();
        }
