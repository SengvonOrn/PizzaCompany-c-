...
{
    public partial class KitMenuForm : Form
    {
        ...
        public void Getdata()
        {
            ...
            List<ProductModel> products = mainClass.GetProductsBySearch(searchMenu.Text, "Kit Menu", "", "");
        ...
        private void KitMenuForm_Load(object sender, EventArgs e)
        {
            Getdata();
        }
